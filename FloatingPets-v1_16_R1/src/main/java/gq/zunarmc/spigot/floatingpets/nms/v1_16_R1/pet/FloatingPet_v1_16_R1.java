package gq.zunarmc.spigot.floatingpets.nms.v1_16_R1.pet;
...
public class FloatingPet_v1_16_R1 extends EntityCat implements FloatingPet {
    ...
    public void transformEntity(){
        ...
        if(isSetting(Setting.PET_DAMAGE_BY_ATTACK)) {
            goalSelector.a(0, new gq.zunarmc.spigot.floatingpets.nms.v1_16_R1.pathfinder.PathfinderGoalOwnerHurtByTarget(this,
                    ((CraftPlayer) onlineOwner).getHandle()));
            goalSelector.a(0, new gq.zunarmc.spigot.floatingpets.nms.v1_16_R1.pathfinder.PathfinderGoalOwnerHurtTarget(this,
                    ((CraftPlayer) onlineOwner).getHandle()));
        }

        goalSelector.a(7, new PathfinderGoalRandomStrollLand(this, 1.0D));

        goalSelector.a(8, new gq.zunarmc.spigot.floatingpets.nms.v1_16_R1.pathfinder.PathfinderGoalFollowOwner(this, onlineOwner, 1.2));
