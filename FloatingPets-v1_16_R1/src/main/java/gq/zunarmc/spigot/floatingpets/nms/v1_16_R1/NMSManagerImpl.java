package gq.zunarmc.spigot.floatingpets.nms.v1_16_R1;
...
import gq.zunarmc.spigot.floatingpets.api.nms.NMSManager;
import gq.zunarmc.spigot.floatingpets.nms.v1_16_R1.pet.FloatingPet_v1_16_R1;
...
public class NMSManagerImpl implements NMSManager {
    ...
    public void registerEntity() {
        ...
        EntityTypes<Entity> a = EntityTypes.Builder.a(FloatingPet_v1_16_R1::new, EnumCreatureType.CREATURE).a(customName);
        entityStore = IRegistry.a(IRegistry.ENTITY_TYPE, customName, a);
    }
    ...
    public FloatingPet constructPet(Location location, Player onlineOwner, Pet pet, Map<Setting, String> settings) {
        ...
        FloatingPet_v1_16_R1 nmsPet = (FloatingPet_v1_16_R1) b;
        if(nmsPet == null)
            return null;

        nmsPet.construct(location, onlineOwner, pet, settings);
        return (FloatingPet_v1_16_R1) b;
    }
    ...
    public void killPets() {
        Bukkit.getWorlds().forEach(world -> world.getEntities().forEach(entity -> {
            ...
            if(ent.getHandle() instanceof FloatingPet_v1_16_R1 || ent.hasMetadata("FloatingPets_Pet")){
                ent.remove();
                ((FloatingPet_v1_16_R1) ent.getHandle()).kill();
            }
        }));
    }
