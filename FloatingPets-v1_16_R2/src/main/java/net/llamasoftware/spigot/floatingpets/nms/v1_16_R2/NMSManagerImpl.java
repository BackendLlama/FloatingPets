package net.llamasoftware.spigot.floatingpets.nms.v1_16_R2;
...
import net.llamasoftware.spigot.floatingpets.nms.v1_16_R2.pet.FloatingPet_v1_16_R2;
...
public class NMSManagerImpl implements NMSManager {
    ...
    public void registerEntity() {
        ...
        EntityTypes<Entity> a = EntityTypes.Builder.a(FloatingPet_v1_16_R2::new, EnumCreatureType.CREATURE).a(customName);
    ...
    public FloatingPet constructPet(Location location, Player onlineOwner, Pet pet, Map<Setting, String> settings) {
        ...
        FloatingPet_v1_16_R2 nmsPet = (FloatingPet_v1_16_R2) b;
        if(nmsPet == null)
            return null;

        nmsPet.construct(location, onlineOwner, pet, settings);
        return (FloatingPet_v1_16_R2) b;
    }
