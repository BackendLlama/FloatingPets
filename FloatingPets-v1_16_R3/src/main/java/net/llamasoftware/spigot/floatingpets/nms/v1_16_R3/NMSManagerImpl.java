...
import net.llamasoftware.spigot.floatingpets.nms.v1_16_R3.pet.FloatingPet_v1_16_R3;
...
public class NMSManagerImpl implements NMSManager {
    ...
    public void registerEntity() {
        ...
        EntityTypes<Entity> a = EntityTypes.Builder.a(FloatingPet_v1_16_R3::new, EnumCreatureType.CREATURE).a(customName);
    ...
    public FloatingPet constructPet(Location location, Player onlineOwner, Pet pet, Map<Setting, String> settings) {
        ...
        FloatingPet_v1_16_R3 nmsPet = (FloatingPet_v1_16_R3) b;
        if(nmsPet == null)
            return null;

        nmsPet.construct(location, onlineOwner, pet, settings);
        return (FloatingPet_v1_16_R3) b;
    }
    ...
    public void killPets() {
        Bukkit.getWorlds().forEach(world -> world.getEntities().forEach(entity -> {
            ...
            if(ent.getHandle() instanceof FloatingPet_v1_16_R3 || ent.hasMetadata("FloatingPets_Pet")){
                ent.remove();
            }
        }));
    }
